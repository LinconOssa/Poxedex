...
$sql="SELECT * FROM pokedex WHERE id2='$id2'";
$query=mysqli_query($conexion,$sql);
$row=mysqli_fetch_array($query);
if ($inc) {
  $consulta= "SELECT * FROM pokedex WHERE id2='$id2'";
...
<html lang="en">
    ...
    <body>
    <header><div style="position: fixed; z-index:2;	width: 100%; height: 70px; background: rgb(247, 37, 37);display: flex; flex-direction: row;
	text-align: right;">
            <div id="logo">
                <a href="../index.php">
                    <img src="ima/l.png">
            ...
            <nav id="menu">
                    <ul>
                        ...
                        <li><a href="../evolucionm/index.php"><p>Evolucion media </p> </a></li>
...
<div id="pokedex-container">
  <div id="pokedex">
    ...
    <div id="screen-row">
      ...
      <p><?php echo $row['nombre2']  ?></p>
      <div id="number-pokemon">
      <p>00<?php echo $row['id2']  ?></p>
    </div>
    <div id="e"><?php echo $row['descripcion2']  ?></div>
    <div id="extra-info-pokemon-row">
                <div class="extra-info-screen" id="extra-info-screen-1">Peso:<?php echo $row['peso2']  ?></div>
        <div class="extra-info-screen" id="extra-info-screen-2">Altura:<?php echo $row['altura2'] ?></div>
        </div> 
        </li>      
    <li id="slide1">
    ...
    <div id="number-pokemon">
    <p>00<?php echo $row['id']  ?></p>
   </div> 
 
        <div id="screen-description1"><?php echo $row['descripcion']  ?></div>
        <div id="extra-info-pokemon-row">
                <div class="extra-info-screen" id="extra-info-screen-1">Peso:<?php echo $row['peso']  ?></div>
        <div class="extra-info-screen" id="extra-info-screen-2">Altura:<?php echo $row['altura'] ?></div>
        </div>
    ...
    <img src="<?php echo $row['img3']  ?>"/>
      <p><?php echo $row['nombre3']  ?></p>
      <div id="number-pokemon">
      <p>00<?php echo $row['id3']  ?></p>
    </div>
    <div id="screen-description3"><?php echo $row['descripcion3']  ?></div>
    <div id="extra-info-pokemon-row">
                <div class="extra-info-screen" id="extra-info-screen-1">Peso:<?php echo $row['peso3']  ?></div>
        <div class="extra-info-screen" id="extra-info-screen-2">Altura:<?php echo $row['altura3'] ?></div>
        </div>
          ...
          <div id="cross">
           ...
           if ($nombre == "") {
              ...
              ?> 
                            ...
                            <a href="#slide1">   <div id="leftT"><p>1</p> </div> </a>
            ...
            if ($nombre2 == "") {
              ...
              ?> 
                     ...
                     <a href="#slide2"><div id="midCircle"><p>2</p></div></a>
            ...
            if ($nombre3 == "") {
              ...
              ?> 
                     ...
                     <a href="#slide3"><div id="rightT"><p>3</p></div></a> 
